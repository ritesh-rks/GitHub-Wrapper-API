    ...
    renderProjects(sortedProjects);
        ...
        sortOption.addEventListener('change', () => {
          ...
          if (selectedOption === 'stars') {
            sortedProjects = projects.sort((a, b) => b.stargazers_count - a.stargazers_count);
    ...
    for (let i = 0; i < sortedProjects.length; i++) {
        ...
        reposInfoDiv.innerHTML += `<div class="card">
                <div class="card-body">
                    ...
                    ${sortedProjects[i].description == null ? '<div class="card-description">No Description</div>' : `<div class="card-description">${sortedProjects[i].description}</div>`}
                    <div class="card-subHeading"> <span>${sortedProjects[i].language}</span>
                    <span> <i class="fa-solid fa-code-fork"></i> ${sortedProjects[i].forks}</span>
                    <span> <i class="fa-solid fa-star"></i> ${sortedProjects[i].stargazers_count}</span>
                    <span>${sortedProjects[i].size} Kb</span>
                    </div>
                    <div class="card-text">
                        <button>
                            <a target="_blank"  href=${sortedProjects[i].html_url}>
                                Do checkout Project
                            </a>
                        </button>
                    </div>
